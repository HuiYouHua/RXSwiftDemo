...
//        inputField.rx.controlEvent(.editingDidBegin).subscribe(onNext: {
//            print("开始编辑")
//        }).disposed(by: disposeBag)
//        inputField.rx.controlEvent(.editingChanged).subscribe { (e) in
//            let a = e.element
//
//            print(e.element)
//        }.disposed(by: disposeBag)
//
//        inputField.rx.controlEvent([.editingChanged]) //状态可以组合
//        .asObservable()
//        .subscribe(onNext: { e in
//            print(e)
//        }).disposed(by: disposeBag)
        
        inputField.rx.text.orEmpty.changed
            .subscribe(onNext: {
                print("您输入的是：\($0)")
            })
            .disposed(by: disposeBag)
